...
"""
#events_client.get_alerts(display_output=True) # Get alerts generated by Netskope
#events_client.get_application_events(display_output=True) # Get application events generated by Netskope
#events_client.get_audit_events(display_output=True) # Get audit events generated by Netskope
#events_client.get_exported_alert_events(display_output=False) # Export alerts generated by Netskope
#events_client.get_exported_application_events(display_output=False) # Export application events generated by Netskope
#events_client.get_exported_audit_events(display_output=False) # Export audit events generated by Netskope
#events_client.get_exported_connection_events(display_output=False) # Export connection events generated by Netskope
#events_client.get_exported_incident_events(display_output=False) # Export DLP incidents generated by Netskope
#events_client.get_exported_infrastructure_events(display_output=False) # Export infrastructure events generated by Netskope
#events_client.get_exported_network_events(display_output=False) # Export network events generated by Netskope
#events_client.get_exported_page_events(display_output=False) # Export page events generated by Netskope
...
"""
#services_client.get_cci_app_info(display_output=False) # Get CCI related application information based on the apps/category/ccl/connector/discovered/domain/ids/tag.
#services_client.get_cci_domain(display_output=False) # Get the steering & discovery domains for the application/id.
#services_client.get_cci_tags(display_output=False) # Get tags for the list of applications/ids.
#services_client.create_cci_tags(data, display_output=False) # Creates new tag and associate the same to the list of applications/ids. <---payload---> { "tag": "ccl_high", "apps": [ "Box", "Amazon Database" ], "ids": [ 1, 2 ] }
#services_client.add_cci_tags(tag, data, display_output=False) # Add existing tag to the list of applications/ids. <---payload---> { "apps": [ "Box", "Amazon Database" ], "ids": [ 1, 2 ], "action": "append" }
#services_client.get_pending_bandwidth_changes(display_output=False) # Get bandwidth control pending changes.
#services_client.apply_bandwidth_changes(data, display_output=False) # Apply bandwidth control pending changes. <---payload---> { "links": [ 1 ], "traffic_classes": [ 1 ], "policies": [ 1 ], "traffic_class_rules": [ 1 ] }
#services_client.create_bandwidth_links(data, display_output=False) # Create bandwidth control links. <---payload---> [ { "name": "link1", "definition": { "ipsec_sites": [ "ipsec_site1" ] }, "size": "100 mbps" } ]
#services_client.update_bandwidth_links(data, display_output=False) # Update bandwidth control links. <---payload---> [ { "id": 1, "name": "link1", "definition": { "ipsec_sites": [ "ipsec_site1" ] }, "size": "100 mbps" } ]
#services_client.delete_bandwidth_control_link(data, display_output=False) # Delete a bandwidth control link.  <---payload---> [ 1 ]
#services_client.get_bandwidth_control_link(data, display_output=False) # Get bandwidth control link.  <---payload---> { "filters": { "name": { "value": "Link_name", "operator": "like" }, "ipsec_site": { "value": [ "Site1" ] }, "last_edit": { "value": { "starttime": "2023-01-30 06:01:01", "endtime": "2023-01-30 07:01:01" } } } }
#services_client.get_bandwidth_control_link(link_id, display_output=False) # Get bandwidth control link.
#services_client.update_bandwidth_control_link(link_id, data, display_output=False) # Update a bandwidth control link. <---payload---> [ { "name": "link1", "definition": { "ipsec_sites": [ "ipsec_site1" ] }, "size": "100 mbps" } ]
#services_client.delete_bandwidth_control_link(link_id, display_output=False) # Delete a bandwidth control link.
#services_client.create_bandwidth_control_policies(data, display_output=False) # Create bandwidth control policies. <---payload---> [ { "name": "policy1", "links": [ "link1" ], "all_links": false, "bandwidth_limits": [ { "traffic_class": "traffic_class1", "max_bandwidth": "100 mbps", "type": "exact" } ], "enabled": true, "order": 1 } ]
#services_client.update_bandwidth_control_policies(data, display_output=False) # Update bandwidth control policies. <---payload---> [ { "id": 1, "name": "policy1", "links": [ "link1" ], "all_links": false, "bandwidth_limits": [ { "traffic_class": "traffic_class1", "max_bandwidth": "100 mbps", "type": "exact" } ], "enabled": true } ]
#services_client.delete_bandwidth_control_policies(data, display_output=False) # Delete bandwidth control policies. <---payload---> [ 1 ]
#services_client.list_bandwidth_control_policies(data, display_output=False) # Get bandwidth control policies list. <---payload---> { "filters": { "name": { "value": "policy_name", "operator": "like" }, "link": { "value": [ "Link1" ] }, "traffic_class": { "value": [ "Class1" ] }, "last_edit": { "value": { "starttime": "2023-01-30 06:01:01", "endtime": "2023-01-30 07:01:01" } } } }
#services_client.get_bandwidth_control_policy(policy_id, display_output=False) # Get bandwidth control policy.
#services_client.update_bandwidth_control_policy(policy_id, data, display_output=False) # Update a bandwidth control policy. <---payload---> { "name": "policy1", "links": [ "link1" ], "all_links": false, "bandwidth_limits": [ { "traffic_class": "traffic_class1", "max_bandwidth": "100 mbps", "type": "exact" } ], "enabled": true, "order": 1 }
#services_client.delete_specific_bandwidth_control_policy(policy_id, display_output=False) # Delete bandwidth control policies.
#services_client.create_bandwidth_control_trafficclasses(data, display_output=False) # Create bandwidth control trafficclasses. <---payload---> [ { "name": "traffic_class1", "description": "description" } ]
#services_client.update_bandwidth_control_trafficclasses(data, display_output=False) # Update bandwidth control trafficclasses. <---payload---> [ { "id": 1, "name": "traffic_class1", "description": "description" } ]
#services_client.list_bandwidth_control_trafficclasses(display_output=False) # Get bandwidth control trafficclasses list.
#services_client.delete_bandwidth_control_trafficclasses(data, display_output=False) # Delete bandwidth control trafficclasses. <---payload---> [ 1 ]
#services_client.get_bandwidth_control_traffic_class(class_id, display_output=False) # Get bandwidth control traffic class rule.
#services_client.update_bandwidth_control_trafficclass(class_id, data, display_output=False)
#services_client.delete_bandwidth_control_trafficclass(class_id, display_output=False)
#services_client.create_bandwidth_control_traffic_class_rules(data, display_output=False) # Create bandwidth control traffic class rules. <---payload---> [ { "source": { "user": [ "user1" ], "user_group": [ "user_group1" ], "organization_unit": [ "organization_unit1" ], "exclude_user": [ "user1" ], "exclude_user_group": [ "user_group1" ], "exclude_organization_unit": [ "organization_unit1" ], "source_ip": [ "1.1.1.1" ] }, "destination": { "application": [ "application1" ], "app_suite": [ "appsuite1" ], "app_category": [ "category1" ], "web_category": [ "web_category1" ] }, "order": 1, "traffic_class": "Video" } ]
#services_client.update_bandwidth_control_traffic_class_rules(data, display_output=False) # Update bandwidth control traffic class rules. <---payload---> [ { "id": 1, "source": { "user": [ "user1" ], "user_group": [ "user_group1" ], "organization_unit": [ "organization_unit1" ], "exclude_user": [ "user1" ], "exclude_user_group": [ "user_group1" ], "exclude_organization_unit": [ "organization_unit1" ], "source_ip": [ "1.1.1.1" ] }, "destination": { "application": [ "application1" ], "app_suite": [ "appsuite1" ], "app_category": [ "category1" ], "web_category": [ "web_category1" ] }, "traffic_class": "Video" } ]
#services_client.list_bandwidth_control_traffic_class_rules(data, display_output=False) # Get bandwidth control traffic class rule list. <---payload---> { "filters": { "user": { "value": "User1", "operator": "like" }, "user_group": { "value": [ "UserGroup1" ] }, "organization_unit": { "value": [ "OU1" ] }, "source_ip": { "value": [ "SourceIP1" ] }, "application": { "value": "App1", "operator": "like" }, "app_suite": { "value": "AppSuite1", "operator": "like" }, "category": { "value": [ "Category1" ] }, "traffic_class": { "value": [ "Class1" ] } } }
#services_client.delete_bandwidth_control_traffic_class_rules(data, display_output=False) # Delete bandwidth control traffic class rules. <---payload---> [ 1 ]
#services_client.get_bandwidth_control_traffic_class_rule(rule_id, display_output=False) # Get bandwidth control traffic class rule.
#services_client.update_bandwidth_control_traffic_class_rule(rule_id, data, display_output=False) # Update a bandwidth control traffic class rule. <---payload---> { "source": { "user": [ "user1" ], "user_group": [ "user_group1" ], "organization_unit": [ "organization_unit1" ], "exclude_user": [ "user1" ], "exclude_user_group": [ "user_group1" ], "exclude_organization_unit": [ "organization_unit1" ], "source_ip": [ "1.1.1.1" ] }, "destination": { "application": [ "application1" ], "app_suite": [ "appsuite1" ], "app_category": [ "category1" ], "web_category": [ "web_category1" ] }, "order": 1, "traffic_class": "Video" }
#services_client.delete_bandwidth_control_traffic_class_rule(rule_id, display_output=False) # Delete a bandwidth control traffic class rule.
