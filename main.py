...
#services_client.get_bandwidth_control_traffic_class(class_id, display_output=True) # Get bandwidth control traffic class.
...
#services_client.get_bandwidth_control_traffic_class(class_id, display_output=True) # Get bandwidth control traffic class.
#services_client.update_bandwidth_control_trafficclass(class_id, data, display_output=True) # Update bandwidth control trafficclass. <---payload---> { "name": "traffic_class1", "description": "description" }
#services_client.delete_bandwidth_control_trafficclass(class_id, display_output=True) # Delete bandwidth control traffic class.
