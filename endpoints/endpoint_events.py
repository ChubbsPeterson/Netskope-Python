...
class Events(BaseClient):
    ...
    def get_alerts(self, display_output=False, type_=None, acked=None, query=None, limit=None, 
               offset=None, insertionstarttime=None, insertionendtime=None):
        """
        ...
        params = {
            ...
            'limit': limit,
            'offset': offset,
            'insertionstarttime': insertionstarttime,
            'insertionendtime': insertionendtime
        }
        response = self.get(endpoint, params=params, display_output=display_output)
    ...
    def get_exported_alert_events(self, display_output=False):
        """
        Export alerts generated by Netskope
        """
        endpoint = "events/dataexport/events/alert"
        response = self.get(endpoint, display_output=display_output)
        return self._handle_response(response)

    def get_exported_application_events(self, display_output=False):
        """
        Export application events generated by Netskope
        """
        endpoint = "events/dataexport/events/application"
        response = self.get(endpoint, display_output=display_output)
        return self._handle_response(response)

    def get_exported_audit_events(self, display_output=False):
        """
        Export audit events generated by Netskope
        """
        endpoint = "events/dataexport/events/audit"
        response = self.get(endpoint, display_output=display_output)
        return self._handle_response(response)

    def get_exported_connection_events(self, display_output=False):
        """
        Export connection events generated by Netskope
        """
        endpoint = "events/dataexport/events/connection"
        response = self.get(endpoint, display_output=display_output)
        return self._handle_response(response)

    def get_exported_incident_events(self, display_output=False):
        """
        Export DLP incidents generated by Netskope
        """
        endpoint = "events/dataexport/events/incident"
        response = self.get(endpoint, display_output=display_output)
        return self._handle_response(response)

    def get_exported_infrastructure_events(self, display_output=False):
        """
        Export infrastructure events generated by Netskope
        """
        endpoint = "events/dataexport/events/infrastructure"
        response = self.get(endpoint, display_output=display_output)
        return self._handle_response(response)

    def get_exported_network_events(self, display_output=False):
        """
        Export network events generated by Netskope
        """
        endpoint = "events/dataexport/events/network"
        response = self.get(endpoint, display_output=display_output)
        return self._handle_response(response)

    def get_exported_page_events(self, display_output=False):
        """
        Export page events generated by Netskope
        """
        endpoint = "events/dataexport/events/page"
        response = self.get(endpoint, display_output=display_output)
        return self._handle_response(response)
